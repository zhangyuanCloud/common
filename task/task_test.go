...
func TestTask(t *testing.T) {
	...
	if err != nil {
		t.Error("run task failed, return a errors", err)
		return
	}
	...
	if err != nil {
		t.Error("run cancelable task failed, return a errors", err)
		return
	}
	...
	_, err = runner.Stop()
	if err != nil {
		t.Error("stop runner failed, return a errors", err)
		return
	}
...
func TestStopWithID(t *testing.T) {
	...
	if err != nil {
		t.Error("stop cancelable task failed, return a errors", err)
		return
	}
