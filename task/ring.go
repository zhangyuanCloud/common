...
// any blocked threads with an errors.  This buffer is similar to the buffer
...
// on the queue.  An errors will be returned if the queue is disposed.
...
// is full, this call will return false.  An errors will be returned if the
// queue is disposed.
...
// to the queue or Dispose is called on the queue.  An errors will be returned
...
// errors will be returned if the queue is disposed or a timeout occurs. A
